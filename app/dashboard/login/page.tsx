  ...
  const getRoleBasedRoute = (user: any) => {
    ...
    switch (roleName) {
      case 'admin':
        ...
        return '/dashboard';
      case 'staff':
        // Staff: can manage students, redirect to calon murid
        return '/dashboard/calon-murid';
      case 'teacher':
        // Teacher: limited access, redirect to dashboard
        return '/dashboard';
      case 'parent':
        // Parent: view only, redirect to dashboard
        return '/dashboard';
      default:
        return '/dashboard';
    }
