        ...
        <section className="bg-gradient-to-r from-primary to-secondary text-white py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl lg:text-5xl font-bold mb-6 animate-bounce">🌟 Hubungi Kami 🌟</h1>
              <p className="text-xl text-blue-100">
                Kami siap membantu Anda dengan informasi lengkap tentang Sekolah Iqrolife! 📞✨
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4 animate-wiggle">🏫 Informasi Kontak 🏫</h2>
                <p className="text-xl text-gray-600">Temukan lokasi dan cara menghubungi kami 📍</p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 border-t-4 border-primary hover:scale-105 transition-transform duration-300">
                  <div className="text-center mb-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">🏢 Kantor Pusat Yasmina-Sekolah Iqrolife</h3>
                  </div>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6 border-t-4 border-secondary hover:scale-105 transition-transform duration-300">
                  <div className="text-center mb-4">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">🎈 Lokasi KB-TK Iqrolife</h3>
                  </div>
                  <div className="space-y-2 text-sm text-gray-600">
                    <p className="flex items-center">
                      <MapPin className="w-4 h-4 mr-2" />
                ...
                {/* SD */}
                <div className="bg-white rounded-2xl shadow-lg p-6 border-t-4 border-accent hover:scale-105 transition-transform duration-300">
                  <div className="text-center mb-4">
                    <div className="w-16 h-16 bg-gradient-to-r from-orange-100 to-orange-200 rounded-full flex items-center justify-center mx-auto mb-3 animate-wiggle">
                      <MapPin className="w-8 h-8 text-accent" />
                    </div>
                    <h3 className="text-lg font-bold text-gray-900">📚 Lokasi SD Iqrolife</h3>
                  </div>
                  <div className="space-y-2 text-sm text-gray-600">
                    <p className="flex items-center">
                      <MapPin className="w-4 h-4 mr-2" />
                      Jl. Raya Dramaga KM 8, Bogor
                    </p>
                    <p className="flex items-center">
                      <Phone className="w-4 h-4 mr-2" />
                      0251-8625-993
                ...
                {/* SMP */}
                <div className="bg-white rounded-2xl shadow-lg p-6 border-t-4 border-purple-600 hover:scale-105 transition-transform duration-300">
                  <div className="text-center mb-4">
                    <div className="w-16 h-16 bg-gradient-to-r from-purple-100 to-purple-200 rounded-full flex items-center justify-center mx-auto mb-3 animate-pulse">
                      <MapPin className="w-8 h-8 text-purple-600" />
                    </div>
                    <h3 className="text-lg font-bold text-gray-900">🎓 Lokasi SMP & HS SMU Iqrolife</h3>
                  </div>
                  <div className="space-y-2 text-sm text-gray-600">
                    <p className="flex items-center">
                      <MapPin className="w-4 h-4 mr-2" />
                      Jl. Raya Dramaga KM 9, Bogor
                    </p>
                    <p className="flex items-center">
                      <Phone className="w-4 h-4 mr-2" />
                      0251-8625-994
              ...
              <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-pink-50 rounded-2xl p-8 shadow-lg">
                  <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">✉️ Kirim Pesan Kepada Kami! ✉️</h3>
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <Textarea placeholder="Tulis pesan Anda di sini..." rows={6} />
                    </div>
                ...
                <div>
                  <div className="bg-gradient-to-br from-blue-100 to-green-100 rounded-2xl h-64 mb-6 flex items-center justify-center shadow-lg">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 font-semibold">Peta Lokasi Sekolah Iqrolife</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4 bg-white rounded-2xl p-4 shadow-lg hover:scale-105 transition-transform duration-300">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">📞 Hotline PPDB</h4>
                        <div className="text-sm text-gray-600 space-y-1">
                    ...
                    <div className="flex items-start space-x-4 bg-white rounded-2xl p-4 shadow-lg hover:scale-105 transition-transform duration-300">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">📧 Email Khusus</h4>
                        <div className="text-sm text-gray-600 space-y-1">
        ...
        <section className="py-16 bg-gradient-to-r from-purple-50 to-pink-50">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4 animate-bounce">❓ Pertanyaan Umum ❓</h2>
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:scale-105 transition-transform duration-300">
                  ...
                  <p className="text-gray-600">
                    Anda dapat mendaftar melalui halaman PPDB kami atau datang langsung ke kantor pusat. Proses
                    pendaftaran dibuka setiap tahun pada bulan Januari-Maret.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:scale-105 transition-transform duration-300">
                  ...
                  <p className="text-gray-600">
                    Ya, kami menyediakan berbagai program beasiswa untuk siswa berprestasi dan kurang mampu. Informasi
                    lengkap dapat diperoleh di bagian akademik.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-lg hover:scale-105 transition-transform duration-300">
                  ...
                  <p className="text-gray-600">
                    Kami menerapkan sistem pembelajaran terpadu yang mengintegrasikan kurikulum nasional dengan
                    nilai-nilai Islam, didukung teknologi modern dan metode pembelajaran aktif.
                  </p>
                </div>
              </div>
            </div>
