          ...
          <div className="grid items-center gap-8 md:grid-cols-2">
            <div className="order-2 md:order-1">
              ...
              <p className="mt-3 leading-relaxed text-muted-foreground">
                Yayasan Tumbuh Bersama Iqrolife berkomitmen membangun lingkungan
                pendidikan yang profesional, hangat, dan kekeluargaan. Kami
                mendampingi pertumbuhan anak dan keluarga melalui program yang
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <Button
                  variant="outline"
                  className="transition-transform hover:-translate-y-0.5 bg-transparent"
                >
                  Hubungi Kami
                </Button>
              </div>
          ...
          <div className="mx-auto max-w-6xl px-4 py-10 md:px-6 md:py-14">
            <div className="grid gap-6 md:grid-cols-3">
              {[
                {
                  title: 'Profesional',
                  desc: 'Standar mutu, proses rapi, dan akuntabel.',
                },
                {
                  title: 'Kekeluargaan',
                  desc: 'Pendekatan hangat yang merangkul orang tua.',
                },
                {
                  title: 'Kolaboratif',
                  desc: 'Bersinergi dengan guru, orang tua, dan komunitas.',
                },
              ].map((item) => (
                <div
                  key={item.title}
