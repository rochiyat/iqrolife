      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-2xl mx-auto mb-12">
          {locations.map((location, index) => (
            <Card key={index} className="bg-white/80 backdrop-blur-sm border-2 border-brand-emerald/20 shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="text-brand-gray font-medium">{location.phone}</p>
                  </div>
                  <div className="flex items-center">
                    <svg
                      className="w-6 h-6 text-brand-cyan mr-3"
                    ...
                    <p className="text-brand-gray font-medium">{location.email}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="text-center">
          <Button asChild size="lg" className="bg-brand-emerald hover:bg-brand-cyan text-white shadow-lg transition-all duration-300 hover:scale-105">
            <a
